    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="#" class="logo">
            <img src="./assets/images/bite_logo.png" width="160" height="50" loading="lazy" alt="grilli home">
          </a>

          <address class="body-4">
            Oppsite Bashah Istambul F7 Markaz, 
            Islambad, PK
          </address>

          <a href="mailto:booking@grilli.com" class="body-4 contact-link">booking@grilli.com</a>

          <a href="tel:+88123123456" class="body-4 contact-link">Booking Request : +92-123-123456</a>
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2025 Bite & Bloom. All Rights Reserved 
        </p>
